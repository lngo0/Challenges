...
class MyRegex {
    /*
        Can contain single digit ([0-9])
        Can contain two digits  ([0-9][0-9])
        Range from 099 to 199  ((0|1)[0-9][0-9])
        Range from 200 to 249  (2[0-4][0-9])
        Range from 250 to 255  (25[0-5])
     */
    String rgx = "([0-9]|[0-9][0-9]|(0|1)[0-9][0-9]|2[0-4][0-9]|25[0-5])";
    public String pattern = rgx + "." + rgx + "." + rgx + "." + rgx;
}
