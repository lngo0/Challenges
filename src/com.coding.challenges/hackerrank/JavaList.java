...
public class JavaList {
    /*
        Given a list, L, of N integers, perform  queries on the list. Once all queries are completed,
        ...
        The 2Q subsequent lines describe the queries, and each query is described over two lines:
            ...
            and the value y must be inserted into  at index x.
            - If the first line of a query contains the String Delete, then the second line contains index x, whose element must be deleted from .
